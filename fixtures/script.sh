...
# peer channel create -c chainhero -f artifacts/chainhero.channel.tx  -o orderer.hf.chainhero.io:7050 --tls --cafile 
...
# peer channel join -b artifacts/orderer.genesis.block
